	...
	Object.defineProperty( this, 'req', {
		...
		set: function(req) {
			...
			['call-id','cseq','from','to'].forEach( function( hdr ){
				if( req.has( hdr ) && !self.has( hdr )) { self.msg.set( hdr, req.get(hdr) ) ; }
			}) ;
			return this ;
		}
	}) ;
...
Response.prototype.send = function( status, reason, opts, callback, fnPrack ) {
	...
	debug('Response#send fnPrack %s', typeof fnPrack);
	this.agent.sendResponse( this, opts, callback, fnPrack ) ;
